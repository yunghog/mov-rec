                ...
                <Col>
                  <div className="highlight1 boxy" style={{marginBottom:'20px'}}>
                    ...
                    <li className="socials">
                      External Profile :
                      <a href={"https://instagram.com/"+ids.instagram_id} target="_blank"><FaInstagram size={30} /></a>
                      <a href={"https://twitter.com/"+ids.twitter_id} target="_blank"><FaTwitter size={30} /></a>
                    </li>
                  </div>
                </Col>
              </Row>
